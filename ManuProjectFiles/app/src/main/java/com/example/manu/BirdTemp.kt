 ...
 */
class BirdTemp(birdName: String, photoResourceId: Int, soundResourceId: Int, englishNameImageResourceId: Int, maoriNameImageResourceId: Int, maoriName: String, endangermentStatusIn: String, funFact: String) {
