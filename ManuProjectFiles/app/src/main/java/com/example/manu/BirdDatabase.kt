...
class BirdDatabase {
    ...
    companion object {  // Makes its embedded functions static.
        ...
        fun compileDatabase() {
            ...
            birds.add(BirdTemp("Australasian Crested Grebe", R.drawable.bird_australasian_crested_grebe,Resources.ID_NULL,"Australasian Crested Grebe", "While there are fewer than 1000 in Aotearoa, there used to be around 200 in the 1980s."))
