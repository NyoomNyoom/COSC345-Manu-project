...
class BirdDatabase {
    ...
    companion object {  // Makes its embedded functions static.
        ...
        fun compileDatabase() {
            ...
            birds.add(BirdTemp("Black Stilt", R.drawable.bird_black_stilt, R.raw.blackstilt, R.drawable.english_black_stilt, R.drawable.maori_black_stilt, "Kakī", "Nationally Critical", "The black stilt is one of the world's rarest wading birds. By 1981 its numbers had dropped to only 23 birds in the wild. By August 2000 the numbers had recovered to only 48 birds in the wild, with another 20 birds in captivity."))
            birds.add(BirdTemp("Blue Duck", R.drawable.bird_blue_duck, R.raw.blueduck, R.drawable.english_blue_duck, R.drawable.maori_blue_duck, "Whio", "Nationally Vulnerable", "Blue Ducks are one of only four duck species in the world who live all year round on fast-flowing rivers. From this harsh and stony environement, the Blue Duck has evolved to have the tip of their bill rubberised to avoid damage against river rocks."))
            ...
            birds.add(BirdTemp("Grey Warbler", R.drawable.bird_grey_warbler, R.raw.greywarbler, R.drawable.english_grey_warbler, R.drawable.maori_grey_warbler, "Riroriro", "Not Threatened", "You are more likely to hear a Grey Warbler than see one as they are incredibly tiny birds weighting in at only 6 grams."))
            ...
            birds.add(BirdTemp("Kākāpō", R.drawable.bird_kakapo, R.raw.kakapo, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Critical", "It's the world's only flightless parrot. Kakapos can't fly. They use their short wings for balance and support rather than flapping. Additionally Kakapo's are incredibly friendly and were kept as pets by both the Maori and early European settlers."))
            birds.add(BirdTemp("Kea", R.drawable.bird_kea, R.raw.kea, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Endangered", "Kea are very intelligent birds with great puzzle solving skills. Kea are often a great threat to tourists as they pull of any rubber on rental cars they can get at."))
            birds.add(BirdTemp("Kōkako", R.drawable.bird_kokako, R.raw.kokako, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Increasing", "The wings of the Kokako are small and weak for its size which limits flight and gliding to short periods of time. Kokakos therefore prefer to run and jump from tree to tree using their strong and long black legs. "))
            birds.add(BirdTemp("Morepork", R.drawable.bird_morepork, R.raw.morepork, R.drawable.english_morepork, R.drawable.maori_morepork, "Ruru", "Not Threatened", "The bird that stands out from the rest due to its unique characteristics is the most widespread owl species, Ruru Morepork. They are generally considered a symbol of wisdom, intelligence, and regal silence in some traditions."))
            ...
            birds.add(BirdTemp("Pūkeko", R.drawable.bird_pukeko, Resources.ID_NULL, Resources.ID_NULL, Resources.ID_NULL, "", "Not Threatened", "Pukeko are capable fliers, as indicated by their presence on many offshore islands around New Zealand. However, their flying does appear awkward and laboured at times, especially when taking off and landing, and, given a choice, they seem to prefer to walk or run than fly."))
            birds.add(BirdTemp("Red Crowned Parakeet", R.drawable.bird_red_crowned_parakeet, R.raw.redcrownedparakeet, R.drawable.english_red_crowned_parakeet, R.drawable.maori_red_crowned_parakeet, "Kākāriki", "Relict", "Red-crowned parakeets typically nest in tree holes, particularly in old trees. Eight subspecies of red-crowned parakeets are known, though two are extinct (Lord Howe and Macquarie Island subspecies). Four are found in New Zealand."))
            ...
            birds.add(BirdTemp("Yellowhead", R.drawable.bird_yellowhead, R.raw.yellowhead, R.drawable.english_yellowhead, R.drawable.maori_yellowhead, "Mohua", "Declining", "Yellowheads are non migratory birds meaning they never leave the forests that they live in"))
        }
