...
class BirdDatabase {
    ...
    companion object {  // Makes its embedded functions static.
        ...
        fun compileDatabase() {
            ...
            birds.add(Bird("Black Stilt", R.drawable.bird_black_stilt, R.raw.blackstilt, R.drawable.english_black_stilt, R.drawable.maori_black_stilt, "Kakī", "Nationally Critical", ""))
            birds.add(Bird("Blue Duck", R.drawable.bird_blue_duck, R.raw.blueduck, R.drawable.english_blue_duck, R.drawable.maori_blue_duck, "Whio", "Nationally Vulnerable", ""))
            ...
            birds.add(Bird("Grey Warbler", R.drawable.bird_grey_warbler, R.raw.greywarbler, R.drawable.english_grey_warbler, R.drawable.maori_grey_warbler, "Riroriro", "Not Threatened", ""))
            birds.add(Bird("Huttons Shearwater", R.drawable.bird_huttons_shearwater, R.raw.huttonsshearwater, R.drawable.english_huttons_shearwater, R.drawable.maori_huttons_shearwater, "Kaikōura tītī", "Nationally Vulnerable", ""))
            birds.add(Bird("Kākāpō", R.drawable.bird_kakapo, R.raw.kakapo, Resources.ID_NULL, Resources.ID_NULL, "", "Endemic", ""))
            birds.add(Bird("Kea", R.drawable.bird_kea, R.raw.kea, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Endangered", ""))
            birds.add(Bird("Kōkako", R.drawable.bird_kokako, R.raw.kokako, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Increasing", ""))
            birds.add(Bird("Morepork", R.drawable.bird_morepork, R.raw.morepork, R.drawable.english_morepork, R.drawable.maori_morepork, "Ruru", "Not Threatened", ""))
            birds.add(Bird("New Zealand Dotterel", R.drawable.bird_new_zealand_dotterel, R.raw.nzdotterel, R.drawable.english_new_zealand_dotterel, R.drawable.maori_new_zealand_dotterel, "Tūturiwhatu",  "Recovering", ""))
            birds.add(Bird("New Zealand Falcon", R.drawable.bird_new_zealand_falcon, R.raw.nzfalcon, R.drawable.english_new_zealand_falcon, R.drawable.maori_new_zealand_falcon, "Kārearea", "Recovering", ""))
            birds.add(Bird("New Zealand Pigeon", R.drawable.bird_new_zealand_pigeon, R.raw.nzpigeon, R.drawable.english_new_zealand_pigeon, R.drawable.maori_new_zealand_pigeon, "Kererū", "Not Threatened", ""))
            birds.add(Bird("North Island Brown Kiwi", R.drawable.bird_north_island_brown_kiwi, Resources.ID_NULL, R.drawable.english_north_island_brown_kiwi, R.drawable.maori_north_island_brown_kiwi, "Kiwi-nui", "Not Threatened", ""))
            birds.add(Bird("Orange Fronted Parakeet", R.drawable.bird_orange_fronted_parakeet, R.raw.orangefrontedparakeet, R.drawable.english_orange_fronted_parakeet, R.drawable.maori_orange_fronted_parakeet, "Kākāriki karaka", "Nationally Critical", ""))
            ...
            birds.add(Bird("Pūkeko", R.drawable.bird_pukeko, Resources.ID_NULL, Resources.ID_NULL, Resources.ID_NULL, "", "Not Threatened", ""))
            birds.add(Bird("Red Crowned Parakeet", R.drawable.bird_red_crowned_parakeet, R.raw.redcrownedparakeet, R.drawable.english_red_crowned_parakeet, R.drawable.maori_red_crowned_parakeet, "Kākāriki", "Relict", ""))
            birds.add(Bird("Rock Wren", R.drawable.bird_rock_wren, R.raw.rockwren, R.drawable.english_rock_wren, R.drawable.maori_rock_wren, "Pīwauwau", "Nationally Endangered", ""))
            birds.add(Bird("Silvereye", R.drawable.bird_silvereye, R.raw.silvereye, R.drawable.english_silvereye, R.drawable.maori_silvereye, "Tauhou", "Not Threatened", ""))
            birds.add(Bird("Stitchbird", R.drawable.bird_stitchbird, R.raw.stitchbird, R.drawable.english_stitchbird, R.drawable.maori_stitchbird, "Hihi", "Nationally Vulnerable", ""))
            birds.add(Bird("Takahē", R.drawable.bird_takahe, R.raw.takahe, Resources.ID_NULL, Resources.ID_NULL, "", "Nationally Vulnerable", ""))
            ...
            birds.add(Bird("Weka", R.drawable.bird_weka, R.raw.weka, Resources.ID_NULL, Resources.ID_NULL, "", "Not Threatened", ""))
            birds.add(Bird("Westland Black Petrel", R.drawable.bird_westland_black_petrel, R.raw.westlandblackpetrel, R.drawable.english_westland_black_petral, R.drawable.maori_westland_black_petral, "Tāiko", "Naturally Uncommon", ""))
            birds.add(Bird("White Heron", R.drawable.bird_white_heron, R.raw.whiteheron, R.drawable.english_white_heron, R.drawable.maori_white_heron, "Kōtuku", "Nationally Critical", ""))
            birds.add(Bird("Whitehead", R.drawable.bird_whitehead, R.raw.whitehead, R.drawable.english_whitehead, R.drawable.maori_whitehead, "Pōpokotea", "Not Threatened", ""))
            birds.add(Bird("Yellow Eyed Penguin", R.drawable.bird_yellow_eyed_penguin, R.raw.yelloweyedpenguin, R.drawable.english_yellow_eyed_penguin, R.drawable.maori_yellow_eyed_penguin, "Hoiho", "Not Threatened", ""))
            birds.add(Bird("Yellowhead", R.drawable.bird_yellowhead, R.raw.yellowhead, R.drawable.english_yellowhead, R.drawable.maori_yellowhead, "Mohua", "Declining", ""))
        }
