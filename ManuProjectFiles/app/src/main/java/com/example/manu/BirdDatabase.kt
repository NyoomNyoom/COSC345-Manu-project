...
class BirdDatabase {
    ...
    companion object {  // Makes its embedded functions static.
        ...
        fun compileDatabase() {
            ...
            birds.add(BirdTemp("Kākāpō", R.drawable.bird_kakapo, Resources.ID_NULL, "", ""))
            birds.add(BirdTemp("Kea", R.drawable.bird_kea, Resources.ID_NULL, "", ""))
            birds.add(BirdTemp("Kōkako", R.drawable.bird_kokako, Resources.ID_NULL, "", ""))
            ...
            birds.add(BirdTemp("Takahē", R.drawable.bird_takahe, Resources.ID_NULL, "", ""))
            birds.add(BirdTemp("Tūī", R.drawable.bird_tui, Resources.ID_NULL, "", "Early European Settlers referred to the Tūī as the 'parson bird', presumably because the white tufts of feathers on the front of its neck resembled a priest's clerical collar."))
